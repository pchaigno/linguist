...
<\body>
  <expand|tmdoc-title|Typographie mathématique>
  ...
  <\description>
    ...
    Similarly, the distance between the baselines of the <with|mode|math|a>
    and the <with|mode|math|i> in <with|mode|math|a<rsub|i>> should not be
    disproportially large with respect to the height of an
    <with|mode|math|x>.
  </description>
  ...
  (like in <with|mode|math|x<rsub|p>+<big|sum><rsub|i=0><rsup|\<infty\>>c<rsub|i>x<rsub|p><rsup|i>>),
  then we might want to opt for different base lines and locally optimize the
  rendering of the first <with|mode|math|x<rsub|p>>.
  ...
  <\expand|equation*>
    \<phi\><left|(><big|sum><rsub|i>a<rsub|i>x<rsup|i><right|)>=\<psi\><left|(><big|sum><rsub|j>b<rsub|j>y<rsup|j><right|)>
  </expand>
  ...
  <\expand|equation*>
    f<left|(><big|sum><rsub|i=1><rsup|b>X<rsub|i><right|)>+g<left|(><big|sum><rsub|j=1><rsup|a>Y<rsub|j><right|)>.
  </expand>
  ...
  <\expand|equation*>
    <left|(>A+<left|(><big|sum><rsub|i=1><rsup|10>B<rsub|i><right|)><rsup|2><right|)>,
  </expand>
...
<\references>
  <\collection>
    ...
    <associate|toc-4|<tuple|3.1|?>>
    <associate|toc-5|<tuple|3.2|?>>
    <associate|toc-6|<tuple|3.3|?>>
    <associate|toc-7|<tuple|3.4|?>>
    <associate|toc-8|<tuple|4|?>>
    <associate|toc-9|<tuple|5|?>>
  </collection>
</references>
...
<\auxiliary>
  <\collection>
    <\associate|idx>
      ...
      family|<quote|ss>|Spécial>|<with|font
      family|<quote|ss>|Move>>|<pageref|idx-1>>

      <tuple|<tuple|<with|font family|<quote|ss>|Insérer>|<with|font
      family|<quote|ss>|Spécial>|<with|font
      family|<quote|ss>|Resize>>|<pageref|idx-2>>
    </associate>
    <\associate|toc>
      ...
      <vspace*|1fn><with|font series|<quote|bold>|math font
      series|<quote|bold>|2<space|2spc>The font
      parameters><value|toc-dots><pageref|toc-2><vspace|0.5fn>

      <vspace*|1fn><with|font series|<quote|bold>|math font
      series|<quote|bold>|3<space|2spc>Some major mathematical
      constructs><value|toc-dots><pageref|toc-3><vspace|0.5fn>

      3.1<space|2spc>Fractions<value|toc-dots><pageref|toc-4>

      3.2<space|2spc>Roots<value|toc-dots><pageref|toc-5>

      3.3<space|2spc>Negations<value|toc-dots><pageref|toc-6>

      3.4<space|2spc>Wide boxes<value|toc-dots><pageref|toc-7>

      <vspace*|1fn><with|font series|<quote|bold>|math font
      series|<quote|bold>|4<space|2spc>Subscripts and
      superscripts><value|toc-dots><pageref|toc-8><vspace|0.5fn>

      <vspace*|1fn><with|font series|<quote|bold>|math font
      series|<quote|bold>|5<space|2spc>Big
      delimiters><value|toc-dots><pageref|toc-9><vspace|0.5fn>
    </associate>
  </collection>
</auxiliary>
