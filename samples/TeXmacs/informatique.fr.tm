...
<\body>
  ...
  il pourrait être intéressant d'accompagner ce fascicule d'une petite vidéo
  ...
  Il faudra les mettre dans un certain ordre, et cela constituera la trame.

  <\itemize>
    <item>langage fonctionnel/langage objet

    <item>histoire des CAS

    <item>listes de langages intéressants pour l'enseignement

    <item>programmer la factorielle dans différents langages
  ...
  <\itemize>
    <item>Qui voudrait se laisser interviewer ?

    <item>Auriez-vous des idées de problématiques

    <item>Quelqu'un est-il intéressé pour écrire la trame ?
