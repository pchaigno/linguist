...
<\body>
  ...
  <\traverse>
    ...
    <extra-branch|Configuración de <TeXmacs>|config/man-configuration.es.tm>

    <extra-branch|Acerca de GNU <TeXmacs>|../about/about.es.tm>

    <extra-branch|Contribuyendo a GNU <TeXmacs>|../about/contribute/contribute.es.tm>
  </traverse>
