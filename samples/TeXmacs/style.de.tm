...
<\body>
  ...
  können. Der Haupt-Stil, der Basis-Stil, wird im Menü
  <name|<menu|Document|Style>> ausgewählt. Er entspricht in der Regel dem
  Dokument, das Sie schreiben wollen: Brief, Buch, Veröffentlichung usw. oder
  eine bestimmende Layout-Politik, wie Sie z.B. viele Verlage vorgeben. Dazu
  können weitere Stil-Pakete hinzugefügt werden, die im Menü
  <menu|Document|Add package> auszuwählen sind. Diese Stil-Pakete
  modifizieren den Basis-Stil. Z.B. dient das Paket <tmpackage|number-europe>
  Paket dazu, die europäische Art der Nummerierung von Abbildungen, Beweisen
  usw. einzuführen, bei jeder einzelne Typ auch einzeln gezählt wird. Das
  Paket <tmpackage|maxima> enthält Makros, um die Ausgabe des Computer
  Algebra Systems <name|Maxima> ansprechend zu formatieren, wenn man
  <TeXmacs> als Oberfläche dafür benutzt. Mehrere Pakete können gleichzeitig
  verwendet werden.
  ...
  bestimmten Zeitschrift nachäffen will. In diesem Kapitel werden wir
  erklären, wie man Basis-Stile und Stilpakete selbst schreibt oder
  vorhandene anpasst.\ 
